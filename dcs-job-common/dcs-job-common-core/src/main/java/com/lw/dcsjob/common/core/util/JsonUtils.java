...
public class JsonUtils {
    ...
    public static class JsonMapper {
        ...
        public static ObjectMapper jacksonObjectMapper() {
            ...
            DateTimeFormatter dateTimeFormatter = DateTimeFormatter.ofPattern(SystemConstants.YYYY_MM_DD_HH_MM_SS);
            DateTimeFormatter localDateFormatter = DateTimeFormatter.ofPattern(SystemConstants.YYYY_MM_DD);
            ...
            javaTimeModule.addDeserializer(LocalDate.class, new JsonDeserializer<LocalDate>() {
                ...
                public LocalDate deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) throws IOException {
                    ...
                    return StrUtil.isBlank(value) ? null : LocalDateTime.parse(value, DateTimeFormatter.ofPattern(SystemConstants.YYYY_MM_DD_HH_MM_SS)).toLocalDate();
                }
            });
            javaTimeModule.addDeserializer(LocalDateTime.class, new JsonDeserializer<LocalDateTime>() {
                ...
                public LocalDateTime deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) throws IOException {
                    String value = jsonParser.getValueAsString();
                    return StrUtil.isBlank(value) ? null : LocalDateTime.parse(value, DateTimeFormatter.ofPattern(SystemConstants.YYYY_MM_DD_HH_MM_SS));
                }
            });
        ...
        private static String toJsonString(Object object) {
            try {
                ...
                throw new DcsJobCommonException("对象转Json失败！", e);
            }
        }
        ...
        private static <T> T toJavaObject(String jsonString, Class<T> clazz) {
            try {
                ...
                throw new DcsJobCommonException("Json转对象失败 参数:{}", jsonString, e);
            }
        }
        ...
        private static JsonNode toJson(byte[] jsonBytes) {
            try {
                ...
                throw new DcsJobCommonException("Json转对象失败！", e);
            }
        }
